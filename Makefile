...
build:
	...
	cp $(SCRIPTS) $(BIN_DIR)/
	chmod 0755 $(BIN_DIR)/radigest $(CACHED_SCREEN_BIN) $(BENCH_SCREEN_BIN) $(BIN_DIR)/radigest-screen-pairs $(BIN_DIR)/radigest-rank-pairs $(BIN_DIR)/radigest-plan-depth $(BIN_DIR)/radigest-fit-size-model
